...
module Jekyll
  ...
  class Cloud < Liquid::Tag
    ...
    def render(context)
      ...
      html << "width='100%' height='600' bgcolor='#{bgcolor}' id='tagcloudflash' name='tagcloudflash' quality='high' allowscriptaccess='always'"
...
Liquid::Template.register_tag('category_cloud_big', Jekyll::Cloud)
Liquid::Template.register_tag('tag_cloud_big', Jekyll::Cloud)
